...
Triplet prescreening is performed once with ordinary T0 at
|dlpno__t_cut_tno_pre|. The complete-triples stage directly reuses both the
surviving triplet list and the screened ordinary-triples contribution from that
calculation; no separate cT0 prescreen is performed. For the surviving triplets,
T0 and cT0 are formed together at |dlpno__t_cut_tno_ct|. The difference between
T0 at the tight |dlpno__t_cut_tno| cutoff and T0 at
|dlpno__t_cut_tno_ct| is added as a
