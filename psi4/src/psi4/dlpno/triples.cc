...
#pragma omp critical
        ...
        std::vector<int> ij_idx_list = index_list(pair_ext_domain, lmopair_to_paos_[ij]);
        ...
        std::vector<int> jk_idx_list = index_list(pair_ext_domain, lmopair_to_paos_[jk]);
        ...
        std::vector<int> ik_idx_list = index_list(pair_ext_domain, lmopair_to_paos_[ik]);
            ...
            for (int b_ijk = 0; b_ijk < ntno_ijk; b_ijk++) {
                for (int c_ijk = 0; c_ijk < ntno_ijk; c_ijk++) {
                    (*V_ijk)(a_ijk, b_ijk * ntno_ijk + c_ijk) += (*T_i)(a_ijk, 0) * (*K_jk)(b_ijk, c_ijk) +
                                                                 ...
                                                                 (*Fia)(a_ijk, 0) * (*T_jk)(b_ijk, c_ijk) + 
                                                                 (*Fjb)(b_ijk, 0) * (*T_ik)(a_ijk, c_ijk) + 
                                                                 (*Fkc)(c_ijk, 0) * (*T_ij)(a_ijk, b_ijk);
                }
            }
        }
